...
public class UpdateRestaurantDTO   {
  ...
  public UpdateRestaurantDTO name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateRestaurantDTO numberOfTables(Integer numberOfTables) {
  ...
  public UpdateRestaurantDTO address(String address) {
  ...
  public UpdateRestaurantDTO city(String city) {
    this.city = city;
    return this;
  }
  ...
  public UpdateRestaurantDTO state(String state) {
    this.state = state;
    return this;
  }
  ...
  public UpdateRestaurantDTO type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public UpdateRestaurantDTO openedAt(String openedAt) {
  ...
  public UpdateRestaurantDTO closedAt(String closedAt) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateRestaurantDTO updateRestaurant = (UpdateRestaurantDTO) o;
    return Objects.equals(this.name, updateRestaurant.name) &&
        Objects.equals(this.numberOfTables, updateRestaurant.numberOfTables) &&
        Objects.equals(this.address, updateRestaurant.address) &&
        Objects.equals(this.city, updateRestaurant.city) &&
        Objects.equals(this.state, updateRestaurant.state) &&
        Objects.equals(this.type, updateRestaurant.type) &&
        Objects.equals(this.openedAt, updateRestaurant.openedAt) &&
        Objects.equals(this.closedAt, updateRestaurant.closedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateRestaurantDTO {\n");
